...
const MoreFeatures = ({ setShowMoreFeatures }) => {
  return (
    <section className="w-full flex flex-col items-center">
      <div className="grid sm:grid-cols-2 md:grid-cols-3 md:px-24 justify-center gap-8 py-12 w-full">
        {moreFeatures.map((feature, index) => (
          <div
            key={feature.id}
            className={`shadow_purple jump-in w-[200px] xs:w-[280px] md:w-[350px]  hover:border hover:border-gray-300 rounded-[15px] p-4 xs:p-6 bg-dark-bg flex gap-4 flex-col`}
          >
