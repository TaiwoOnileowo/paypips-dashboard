...
const Hero = () => {
  return (
    <section className="relative flex xl:h-screen max-xl:gap-16 lg:h-[80vh] max-lg:h-fit  max-xl:flex-col max-xl:items-center max-xl:p-6 max-xl:pt-24 justify-center bg-dark-bg  text-white xl:gap-48">
      <div className="blur absolute z-[0] w-[40%] h-[30%] top-[40%] -left-[3%]  rounded-[50%] opacity-80 bg-shining-gradient" />
      <div className="flex flex-col justify-center z-[1] max-xl:items-center max-lg:mt-8">
